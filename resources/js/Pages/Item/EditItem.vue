...
onMounted(() => {
    axios.get('http://127.0.0.1:8000/api/items/'+ props.item)
        .then((response) => {
...
<template>
    ...
    <div v-else class="w-full p-6">
        ...
        <h4 class="text-lg text-gray-700 font-semibold mb-2">Edit "{{ form.name }}" details</h4>
