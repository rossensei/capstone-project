    ...
    <table class="w-full text-sm text-left text-gray-500">
        <thead class="text-xs text-gray-700 uppercase bg-gray-100">
            <tr>
                ...
                <th scope="col" class="w-52 px-6 py-3 text-center">
                    Action
                </th>
            </tr>
        </thead>
        <tbody>
            <tr class="bg-white border-b hover:bg-gray-50" v-for="(facility, index) in facilities" :key="facility.id">
                <td class="px-6 py-4">
                    {{ (index+1) }}
                </td>
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                    ...
                    <div class="pl-3"> -->
                        <div class="text-base font-semibold">{{ facility.facility_name }}</div>
