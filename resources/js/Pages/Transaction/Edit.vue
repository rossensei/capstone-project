...
import { ArrowLeftIcon, MinusIcon, PlusIcon, TrashIcon } from '@heroicons/vue/24/solid';
...
const form = useForm({
    personnel_id: props.transaction.personnel_id,
    remarks: props.transaction.remarks,
    transaction_items: props.transaction.transaction_items,
})

const submit = () => {
    form.patch('/transactions/update-details/' + props.transaction.id, {
    ...
    <AuthenticatedLayout>
        <div class="py-4">
            <div class="w-full sm:px-6 lg:px-8">
                ...
                <h1 class="font-semibold text-3xl text-gray-700 leading-tight mb-4">Edit transaction</h1>
                                ...
                                <tbody>
                                    <tr class="bg-white border-b" v-for="(transaction_item, index) in form.transaction_items" :key="index">
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                            <div>
                                                <select v-model="transaction_item.item_id" :id="transaction_item.id" disabled class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm">
