...
const confirmDeleteOffice = () => {
    router.delete('/admin/offices/remove-office/' + props.office.id, {
...
<template>
    <div class="p-6">
        <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
                ...
                <div class="text-sm text-gray-800">
                    Are you sure you want to delete "{{ office.office_name }}"?
        ...
        <div class="mt-4 flex justify-end items-center space-x-2">
            ...
            <button class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium" @click="confirmDeleteOffice">Confirm</button>
        </div>
    </div>
</template>